            ...
            def get_user(self, token):
                try:
                    payload = jwt.decode(
                        ...
                        audience="authenticated", options={"require": ["exp", "aud", "id", "email"]},
                    )
                    user = MockUser(payload["email"], role="user")
                    user.id = payload["id"]
                    user.app_metadata = payload.get("app_metadata", {})
                    user.user_metadata = payload.get("user_metadata", {})
